        ...
        <div className="flex">
            ...
            <form className="w-[25rem] h-96" onSubmit={handleSubmit(userSubmit)}>
              ...
              {pageInput === PageInput.DETAIL && (
                  <div className="mt-6 border-t-4 border-gray-300">
                    ...
                    {departs && (
                        <div
                            className="w-[25rem] h-44 border-2 border-[#d9d9d9] absolute bg-white p-3 mt-2 space-y-5 flex flex-col">
          ...
          {successRegister && (
              <div className="absolute w-full flex justify-center items-center self-center">
                <div
                    className="absolute flex-1 flex top-0 justify-center items-center bg-white w-[40rem] h-[5.2rem] border border-black mt-[-5rem] transition-all duration-100">
